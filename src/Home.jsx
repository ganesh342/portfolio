...
const Home = () => {
  ...
  return (
    <motion.div className="bg-stone-800 opacity-4 h-[calc(var(--vh)*100)] w-[calc(var(--vw)*100)] flex flex-col lg:flex-row items-center justify-between">
 ...
 id="animated-text" class="text-4xl font-bold text-white">Competitive programmer</motion.div>
        <div className="flex flex-col lg:flex-row gap-10 items-center justify-between py-5">
          ...
          <div className="flex md:flex-row flex-col items-start gap-6 justify-center py-3">
